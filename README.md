...
A RESTful backend API for a simple e-commerce platform, built using Node.js and Express.js. This project powers core features like product browsing, cart management, user authentication, order placement, and category filtering — perfect for learning full-stack development or integrating into a front-end client.
